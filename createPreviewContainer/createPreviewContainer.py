...
# and liability)
#
# Contact: Marco Neumann [kalinko <at> be-binary [dot] de]
#
...
class CreatePreviewContainer(GeneralReportModuleAdapter):

    # TODO: Rename this.  Will be shown to users when making a report
    moduleName = "Create Preview Container"
    ...
    def getDescription(self):
        return "Report module that takes the selected files and put it into an Container file. The original file pathes shall be preserved."
